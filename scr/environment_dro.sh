...
SPE="dro" #Short name of the species
K=41 #k-mer size
...
GEN_GTF="${SPE_DIR}/Drosophila_melanogaster.BDGP6.46.113.gtf"
GEN_FA="${SPE_DIR}/Drosophila_melanogaster.BDGP6.46.dna_sm.toplevel.fa"
READS_1="${SPE_DIR}/ovarie_1.fastq"
READS_2="${SPE_DIR}/ovarie_2.fastq"
