...
)
{
    ...
    let mut genes_lncRNA = std::collections::HashSet::new();
    ...
    let mut repeats_dfam_lncRNA = std::collections::HashSet::new();
    ...
    let mut repeats_rb_lncRNA = std::collections::HashSet::new();
    ...
    let mut genes_paths_lncRNA = std::collections::HashSet::new();
    ...
    let mut repeats_dfam_paths_lncRNA = std::collections::HashSet::new();
    ...
    let mut repeats_rb_paths_lncRNA = std::collections::HashSet::new();
    ...
    for comp in &components {
            ...
            if nodes.contains_key(unitig) {
                ...
                for genee in genes_list.split("; ") {
                    ...
                    if genee_split[0] != gene && genee_split[0] != "*" {
                        ...
                        } else if position == "lncRNA" {
                            genes_lncRNA.insert(genee_split[0].to_string());
                        }
                    }
                }
                ...
                for repeat in dfam.split("; ") {
                    ...
                    if position == "intron" {
                        ...
                        repeats_dfam_lncRNA.insert(repeat.to_string());
                    }
                }
                for repeat in repbase.split("; ") {
                    if repeat == "*" {
                    ...
                    if position == "intron" {
                        ...
                        repeats_rb_lncRNA.insert(repeat.to_string());
                    }
                }
            } else {
                ...
                for genee in genes_list.split("; ") {
                    ...
                    if genee_split[0] != gene && genee_split[0] != "*" {
                        if position == "intron" {
                            ...
                            genes_paths_lncRNA.insert(genee_split[0].to_string());
                        }
                    }
                }
                for repeat in dfam.split("; ") {
                    ...
                    if position == "intron" {
                        ...
                        repeats_dfam_paths_lncRNA.insert(repeat.to_string());
                    }
                }
                for repeat in repbase.split("; ") {
                    if repeat == "*" {
                    ...
                    if position == "intron" {
                        ...
                        repeats_rb_paths_lncRNA.insert(repeat.to_string());
                    }
                }
            }
        ...
        println!("Genes                 \t {} \t {} \t {} \t {}",genes_intron.len(),genes_utr.len(),genes_cds.len(), genes_lncRNA.len());
        println!("Repeats Dfam          \t {} \t {} \t {} \t {}",repeats_dfam_intron.len(),repeats_dfam_utr.len(),repeats_dfam_cds.len(), repeats_dfam_lncRNA.len());
        println!("Repeats Repbase       \t {} \t {} \t {} \t {}",repeats_rb_intron.len(),repeats_rb_utr.len(),repeats_rb_cds.len(), repeats_rb_lncRNA.len());
        println!("Genes in paths        \t {} \t {} \t {} \t {}",genes_paths_intron.len(),genes_paths_utr.len(),genes_paths_cds.len(), genes_paths_lncRNA.len());
        println!("Repeats Dfam in paths \t {} \t {} \t {} \t {}",repeats_dfam_paths_intron.len(),repeats_dfam_paths_utr.len(),repeats_dfam_paths_cds.len(), repeats_dfam_paths_lncRNA.len());
        println!("Repeats Repbase paths \t {} \t {} \t {} \t {}",repeats_rb_paths_intron.len(),repeats_rb_paths_utr.len(),repeats_rb_paths_cds.len(), repeats_rb_paths_lncRNA.len());
...
)
{
    ...
    let mut repeats_gene_lncRNA = std::collections::HashSet::new();
    ...
    let mut repeats_gene_paths_lncRNA = std::collections::HashSet::new();
            ...
            for genee in genes_list.split("; ") {
                ...
                if genee_split[0] != "*" {
                    ...
                    if position == "intron" {
                        ...
                        repeats_gene_lncRNA.insert(genee_split[0].to_string());
                    }
                }
            }
        ...
        for genee in genes_list.split("; ") {
            ...
            if genee_split[0] != "*" {
                ...
                if position == "intron" {
                    ...
                    repeats_gene_paths_lncRNA.insert(genee_split[0].to_string());
                }
            }
        }
        for repeat_it in dfam.split("; ") {
    ...
    println!(">{}\n                      \t Int \t UTR \t CDS \t lncRNA \t TE",repeat);
    println!("Genes                 \t {} \t {} \t {} \t {}",repeats_gene_intron.len(),repeats_gene_utr.len(),repeats_gene_cds.len(), repeats_gene_lncRNA.len());
    println!("Gene paths            \t {} \t {} \t {} \t {}",repeats_gene_paths_intron.len(),repeats_gene_paths_utr.len(),repeats_gene_paths_cds.len(), repeats_gene_paths_lncRNA.len());
